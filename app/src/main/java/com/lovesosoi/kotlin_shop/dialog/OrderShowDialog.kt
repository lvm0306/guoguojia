...
class OrderShowDialog(context: Context, themeResId: Int) : Dialog(context, themeResId) {
    ...
    private fun initView() {
        ...
        var ll_info = findViewById<LinearLayout>(R.id.ll_info)
        var tv_goodsitem = findViewById<TextView>(R.id.tv_goodsitem)
        var tv_allprice = findViewById<TextView>(R.id.tv_allprice)
        var tv_delete = findViewById<TextView>(R.id.tv_delete)
        var tv_edit = findViewById<TextView>(R.id.tv_edit)
        var tv_print = findViewById<TextView>(R.id.tv_print)
        ...
        if (listener != null) {
            ...
            tv_edit.setOnClickListener { v: View? -> listener?.print(0, data!!) }
        }
    ...
    public fun initData(d:OrderList.DataBean.OrderBean){
        data=d
    }
